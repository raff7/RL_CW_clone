...
# Default
python main.py --max_trans 50000 --n_workers 12 --train_every 50 --copy_every 1500 --start_eps .95 --eps_decay 2500000 --lr 0.001 --lr_decay 1 --l2alpha 0.01 --discount_factor 0.99 --n_hidden_nodes 64 --save_name base_model_test

killall -9 rcssserver
sleep 10

python main.py --max_trans 50000 --n_workers 20 --train_every 150 --copy_every 3000 --start_eps .95 --eps_decay 2500000 --lr 0.001 --lr_decay 1 --l2alpha 0.01 --discount_factor 0.99 --n_hidden_nodes 64 --save_name more_workers_test

killall -9 rcssserver
sleep 10

python main.py --max_trans 50000 --n_workers 12 --train_every 50 --copy_every 1500 --start_eps .95 --eps_decay 1200000 --lr 0.001 --lr_decay 1 --l2alpha 0.01 --discount_factor 0.99 --n_hidden_nodes 64 --save_name less_iters_test
